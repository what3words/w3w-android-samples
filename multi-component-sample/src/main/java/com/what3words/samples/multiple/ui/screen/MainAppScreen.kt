...
import com.what3words.samples.multiple.ui.screen.view.AddMarkerDialog
...
import com.what3words.samples.multiple.ui.screen.view.RemoveAllMarkersDialog
import com.what3words.samples.multiple.ui.screen.view.RemoveSpecificMarkersDialog
                            ...
                            coroutineScope.launch {
                                ...
                                if (listName != null) {
                                    mapManager.addMarkerAt(
                                        ...
                                        markerColor = com.what3words.components.compose.maps.models.W3WMarkerColor(
                                            backgroundColor,
                                            slashColor
                                        ),
                                        listName = listName
                        ...
                        onConfirmBatch = { size, listName, backgroundColor, slashColor ->
                            ...
                            coroutineScope.launch {
                                mapManager.addMarkersAt(
                                    markers,
                                    listName,
                                    com.what3words.components.compose.maps.models.W3WMarkerColor(
                                        backgroundColor,
                                        slashColor
                                    )
                                )
